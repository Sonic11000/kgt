...
redis:setex(KGT..":ZhrfNow:"..msg.sender_user_id_,500,true)
sendMsg(msg.chat_id_,msg.id_,"| حسننا , الان يمكنك ارسال الاسم ولبعض الرموز المميزه اكتب رموز")    
return false
end

if redis:get(KGT..":ZhrfNow:"..msg.sender_user_id_) then
redis:del(KGT..":ZhrfNow:"..msg.sender_user_id_)
...
if msg.text and msg.type ~= "pv" and redis:get(KGT..":ZhrfNow:"..msg.sender_user_id_) then
Text = msg.text
redis:del(KGT..":ZhrfNow:"..msg.sender_user_id_)
if utf8.len(msg.text) > 300 then
